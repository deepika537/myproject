  ...
  public static function toString($diff, $separator = "\n"){
    ...
    foreach ($diff as $line){
      ...
      switch ($line[1]){
        ...
        case self::DELETED    : $string .= '- ' . "<div style='background-color: #faa'><strike>".$line[0]."</strike></div>";break;
        case self::INSERTED   : $string .= '+ ' . "<div style='background-color: #dfd'>".$line[0]."</div>";break;
      }
